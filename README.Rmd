...
Otra función muy útil que combina además otra fuente de datos es `income_constant_prices()` que permite calcular el ingreso a precios constantes, usando como deflactor el IPC o el IPAB. Es necesario definir, el data frame, el año base y el mes base, y el tipo de IPC o IPAB que puede ser "G" (general) o "R" (regional). Este último solo está disponible a partir de 2010.
