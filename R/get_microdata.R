...
download_ech <- function(years = NULL, folder = getwd(), format = "sav") {
  ...
  urls <- data.frame(year = 2011:2018,
                           md_sav = path("http://www.ine.gub.uy/c/document_library", c("get_file?uuid=cc986929-5916-4d4f-a87b-3fb20a169879&groupId=10181",
                           ...
                           md_dat = path("http://www.ine.gub.uy/c/document_library", c("get_file?uuid=7eecaefc-be12-4f5f-93a4-d53cc2a20070&groupId=10181",
                           ...
                           dic = path("http://www.ine.gub.uy/c/document_library", c("get_file?uuid=54523778-5f53-4df1-a265-3ff520941bca&groupId=10181",
