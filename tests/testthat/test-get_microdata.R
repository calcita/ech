...
test_that("download and read data", {
  ...
  testthat::expect_error(get_marco(year = "2016", folder = paste0(tempdir(),"/prueba1"), toR = TRUE))
  testthat::expect_error(get_marco(year = "2016", folder = paste0(tempdir(),"/prueba2"), toR = FALSE))
