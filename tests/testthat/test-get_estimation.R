test_that("get_estimation_mean works", {
  ...
  b <- get_estimation_mean(data = d, variable = "ht11", level = "h", name = "hogares_pobre_mean")
  expect_equal(nrow(b), 1)
  b <- get_estimation_mean(data = d, variable = "ht11", domain = "dpto == 1", level = "h")
  expect_equal(nrow(b), 1)
  b <- get_estimation_mean(data = d, variable = "ht11", by.x = "mes", domain = "dpto == 1", level = "h")
  expect_equal(nrow(b), 12)
  b <- get_estimation_mean(data = d, variable = "ht11", by.x = "dpto", level = "h")
  expect_equal(nrow(b), 19)
  b <- get_estimation_mean(data = d, variable = "ht11", by.x = "dpto", by.y = "mes", level = "h")
  expect_equal(nrow(b), 149)
  b <- get_estimation_mean(data = d, variable = "ht11", by.x = "secc", by.y = "mes", domain = "dpto == 1", level = "i")
...
test_that("get_estimation_total works", {
  ...
  b <- get_estimation_total(data = d, variable = "ht11", level = "h", name = "hogares_pobre_total")
  expect_equal(nrow(b), 1)
  b <- get_estimation_total(data = d, variable = "ht11", domain = "dpto == 1", level = "h")
  expect_equal(nrow(b), 1)
  b <- get_estimation_total(data = d, variable = "ht11", by.x = "mes", domain = "dpto == 1", level = "h")
  expect_equal(nrow(b), 12)
  b <- get_estimation_total(data = d, variable = "ht11", by.x = "dpto", level = "h")
  expect_equal(nrow(b), 19)
  b <- get_estimation_total(data = d, variable = "ht11", by.x = "dpto", by.y = "mes", level = "h")
  expect_equal(nrow(b), 149)
